...
<style>
    :root {
        --dark-chic: #1a1a1a;
        --luxury-gold: #b89552; /* Màu vàng đồng tinh tế nếu cần */
        --soft-border: #f1f1f1;
    }
            ...
            <div>
                <nav style="--bs-breadcrumb-divider: '·';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-1">
                        <li class="breadcrumb-item"><a href="#" class="text-decoration-none text-muted small">CMC Travel</a></li>
            ...
            <div class="col-lg-8">
                <div class="card-luxury mb-4">
                    ...
                    <div class="card-body p-5">
                        <div class="mb-5">
                            <h5 class="label-luxury" style="color: var(--luxury-gold)">{{ $hotel?->name ?? 'CMC Premium Resort' }}</h5>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4">
                                <div class="grid-info-box text-center bg-light border-0">
                                    ...
                                    <div class="value-luxury">{{ $booking->check_in->diffInDays($booking->check_out) }} Đêm</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    @if($booking->status !== 'cancelled' && $booking->check_in->isFuture())
                        <div class="mt-4 pt-4 border-top">
                            <form action="{{ route('bookings.cancel', $booking) }}" method="POST">
                                @csrf
                                <button type="submit" class="btn-cancel-luxury border-0" onclick="return confirm('Bạn chắc chắn muốn hủy hành trình này?')">
                                    Hủy yêu cầu đặt phòng
                                </button>
                            </form>
                            <p class="text-center text-muted mt-3" style="font-size: 9px; text-transform: uppercase; font-weight: 700;">
