    ...
    <div class="container-fluid px-4 py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted small mb-0">Kiểm tra thông tin khách hàng, phòng, lịch ở và xử lý trạng thái đơn hàng.
                </p>
            </div>
        ...
        default => 'Đang chờ thanh toán',
                            ...
                            <div class="col-md-6">
                                <div class="bg-light rounded-4 p-3 h-100">
                                    ...
                                    <div class="small text-muted">
                                        {{ $booking->room?->hotel?->name ?? 'Khách sạn đang cập nhật' }}
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="text-muted small">
                                Quản trị viên có thể xác nhận đơn đặt phòng nếu phòng vẫn còn trống trong khoảng thời gian
                                khách đã chọn. Khi hủy đơn, hệ thống sẽ tự động cập nhật trạng thái mới và thông báo tới
                                khách hàng trong mục lịch sử đặt phòng.
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="d-grid gap-2">
                            ...
                            @if($booking->status !== 'cancelled')
                                <form action="{{ route('admin.bookings.cancel', $booking->id) }}" method="POST">
                                    ...
                                    <button type="submit" class="btn btn-warning text-dark w-100 py-2"
                                        onclick="return confirm('Bạn chắc chắn muốn hủy đơn đặt phòng này?')">Hủy đơn
                                        hàng</button>
                                </form>
                            @endif
                            ...
                            <form action="{{ route('admin.bookings.destroy', $booking->id) }}" method="POST">
                                ...
                                <button type="submit" class="btn btn-outline-danger w-100 py-2"
                                    onclick="return confirm('Cảnh báo: Hành động này sẽ xóa vĩnh viễn đơn đặt phòng khỏi hệ thống!')">Xóa
                                    vĩnh viễn</button>
                            </form>
                        </div>
                    </div>
